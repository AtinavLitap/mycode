...
/* Running the previous example we saw that it resulted in a single instance of, "I run after the data is added to the channel". That's because our unbuffered channel is full. Until it is read out, all other functions must wait.
